...
const TILE_COLORS = [theme.colors.primary, theme.colors.secondary, theme.colors.warning, "#7A9E9F"];
const STEP_MS = 700;
      ...
      <View style={styles.body}>
        {phase === "idle" && (
          <View style={styles.center}>
            <Ionicons name="color-palette" size={48} color={theme.colors.primary} />
            ...
            <TouchableOpacity testID="memory-start" style={styles.startBtn} onPress={startGame}>
            ...
            <View style={styles.grid}>
              {TILE_COLORS.map((color, i) => (
                <TouchableOpacity
                  ...
                  style={[styles.tile, { backgroundColor: color, opacity: activeTile === i ? 1 : 0.35 }]}
                />
              ))}
            </View>
          </>
        ...
        {phase === "gameover" && (
          <View style={styles.center}>
            ...
            <TouchableOpacity testID="memory-retry" style={styles.startBtn} onPress={startGame}>
